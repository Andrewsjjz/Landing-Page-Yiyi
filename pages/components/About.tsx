...
const About = () => {
  ...
  return (
    <div id="About" className="px-8 md:px-32 pb-32 content-center bg-gradient-to-r from-green-700 via-green-500 to-green-300">
      <h1 className="pt-12 uppercase font-Lato font-bold text-center text-white text-bold text-5xl">{about.title}</h1>
      <div className="mt-16 flex flex-col md:flex-row align-center items-center">
        ...
        <div className="pt-8 md:py-0 md:w-1/2 text-white md:ml-4 text-center md:text-left">
          <div className="about__primary">
            <span className="text-3xl font-normal font-Lato">{about.primary}</span>
          </div>
          {/* <div className="mt-6">
